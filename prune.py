...
parser.add_argument('--alpha', type=float, default=0.02,
                    help="Percentage of feature dimensions to be perturbed")
parser.add_argument('--alpha_int', type=int, default=30,
                    help="Number of feature dimensions to be perturbed")
...
for test_model in models:
    ...
    with open(f'{args.dataset}prune+isolate.txt','a') as f:
        f.write(str(args))
        f.write("\nOverall ASR: {:.4f} ({} model, Seed: {})\n".format(overall_asr, args.test_model, args.seed))
        f.write("Overall Clean Accuracy: {:.4f}\n".format(overall_ca))
